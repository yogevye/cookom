const MealOrdersHistorySchema = require('common/mongo-db/src/schemas/meal-orders-history');
...
module.exports = {MealOrdersHistorySchema, MealSchema, OrderSchema, UserSchema};